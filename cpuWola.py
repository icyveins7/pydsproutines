...
def cpu_threaded_wola(y, f_tap, fftlen, Dec):
...
#        return 1
    ...
    _libmc.cpuWola.argtypes = [array_1d_complexdouble, array_1d_double, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, array_1d_complexdouble]
