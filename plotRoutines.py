...
def pgPlotAmpTime(
    ...
    fs : int or float, optional
        Sampling rate of the data. Time vector will be generated for each data array input.
    ...
    if not isinstance(dataList, list) and dataList.ndim == 1:
        dataList = [dataList] # We make it a list so the rest of the processing is identical
